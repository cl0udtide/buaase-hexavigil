...
| `owned_operators_changed` | `operators: Array[Dictionary]` | `RunState` | DeployPanel、CombatSandbox | 已拥有干员槽位变化 |
...
| `unit_deployed` | `unit_runtime_id: int, operator_key: StringName, unit_id: StringName, cell: Vector2i` | `UnitManager` | HUD、DeployPanel | 干员槽位已部署 |
