...
@onready var _detail_label: Label = get_node_or_null("%DetailLabel") as Label
@onready var _cost_badge: Panel = %CostBadge
@onready var _cost_label: Label = %CostLabel
@onready var _selected_overlay: CanvasItem = %SelectedOverlay
@onready var _disabled_overlay: CanvasItem = %DisabledOverlay
