...
func _ready() -> void:
	...
	_wave_preview_title_label.add_theme_color_override("font_shadow_color", Color(0.0, 0.0, 0.0, 0.38))
	...
	_wave_preview_label.add_theme_color_override("font_shadow_color", Color(0.0, 0.0, 0.0, 0.34))
...
func _apply_top_bar_density(viewport_width: float) -> void:
	...
	var label_size := 12 if compact else 14
