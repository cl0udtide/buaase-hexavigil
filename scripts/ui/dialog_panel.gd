...
func _apply_style() -> void:
	...
	GameUiStyle.apply_frame_margin(get_node_or_null("TextBox/TextMargin/VBoxContainer/SpeakerPlate/SpeakerMargin") as MarginContainer, GameUiStyle.FRAME_DIALOG_SPEAKER_PLATE)
