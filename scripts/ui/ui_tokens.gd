...
const LEFT_PANEL_WIDTH_COMPACT := 304.0
const LEFT_PANEL_WIDTH_NARROW := 286.0
const LEFT_PANEL_MIN_HEIGHT := 360.0

const DETAIL_WIDTH := 384.0
const DETAIL_WIDTH_COMPACT := 342.0
const DETAIL_WIDTH_NARROW := 320.0
const DETAIL_TOP := 128.0
const DETAIL_MIN_HEIGHT := 260.0
const DETAIL_MIN_HEIGHT_COMPACT := 260.0
const DETAIL_MIN_HEIGHT_NARROW := 250.0

const WAVE_PREVIEW_HEIGHT := 142.0
const WAVE_PREVIEW_HEIGHT_COMPACT := 124.0
const WAVE_PREVIEW_HEIGHT_NARROW := 112.0
const WAVE_PREVIEW_MIN_HEIGHT := 104.0

const LEGEND_SIZE := Vector2(244.0, 144.0)
const LEGEND_SIZE_COMPACT := Vector2(218.0, 118.0)
const LEGEND_SIZE_NARROW := Vector2(202.0, 104.0)

const DEPLOY_DECK_HEIGHT := 176.0
const DEPLOY_DECK_HEIGHT_COMPACT := 164.0
const DEPLOY_DECK_MIN_WIDTH := 520.0

const ACTION_PANEL_SIZE := Vector2(318.0, 76.0)
const ACTION_PANEL_SIZE_COMPACT := Vector2(304.0, 70.0)
const ACTION_PANEL_SIZE_NARROW := Vector2(286.0, 66.0)

const OPERATOR_CARD_SIZE := Vector2(164.0, 148.0)
const OPERATOR_CARD_COMPACT_SIZE := Vector2(148.0, 138.0)
